...
var React2, defaultMethod, defaultEncType, _excluded, _excluded2, _excluded3, isBrowser2, Link, NavLink, Form, FormImpl, DataRouterHook2, DataRouterStateHook2, SCROLL_RESTORATION_STORAGE_KEY, savedScrollPositions;
...
function createClientRoutes(manifest, routeModulesCache, future, parentId = "", routesByParentId = groupRoutesByParentId(manifest)) {
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    let children = createClientRoutes(manifest, routeModulesCache, future, route.id, routesByParentId);
...
//# sourceMappingURL=/build/_shared/chunk-5LP52SDM.js.map
